...
void CallProcedure(string pName)
{
	...
	Py_Initialize();
	PyObject* my_module = PyImport_ImportModule("JTP3Python");
	PyErr_Print();
...
/*
Description:
	To call the below function, pass the name of the Python function you wish to call and the string parameter you want to send
Example:
...
int CallFuncOneParam(string proc, string param)
{
	...
	pName = PyUnicode_FromString((char*)"JTP3Python");
